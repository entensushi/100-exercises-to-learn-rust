...
impl Order {
    ...
    pub fn new(product_name: String, quantity: u32, unit_price: u32) -> Order {
        if valid_product_name(&product_name) && valid_quantity(&quantity) && valid_unit_price(&unit_price) {
            Order {
                product_name,
                quantity,
                unit_price,
    ...
    pub fn set_product_name(&mut self, new_product_name: String) {
        ...
        if valid_product_name(&new_product_name) {
    ...
    pub fn set_quantity(&mut self, new_quantity: u32) {
        ...
        if valid_quantity(&new_quantity) {
    ...
    pub fn set_unit_price(&mut self, new_unit_price: u32) {
        ...
        if valid_unit_price(&new_unit_price) {
